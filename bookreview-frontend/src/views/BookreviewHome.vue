<template>
  <div class="row">
      ...
      <div v-else class="jumbotron p-4 p-md-5 text-dark rounded bg-light">
        <div class="col-md-12">
          <div class="row overflow-hidden flex-md-row">
            <div class="col d-flex flex-column position-static">
              <p class="d-inline-block mb-2" style="color: #5250c7"></p>
            </div>
          </div>
        </div>
        <div class="col-md-12 px-0 py-3 border-bottom border-primary">
          <h1 class="display-4 font-italic text-center" id="title">
        ...
        <div class="border-top p-1">
          ...
          <p
            ...
            style="text-decoration: underline; font-size: 20px; color: #5250c7"
          >
            Hồ Chí Minh
          </p>
        </div>
    ...
    <div class="col-md-4">
      <h4 style="color: #5250c7">Bài đánh giá</h4>
      <div class="list-group">
        ...
        >
          <div class="d-flex w-100 justify-content-between">
            <strong class="mb-1" style="color: #5250c7">{{
              bookreview.title
            }}</strong>
          </div>
